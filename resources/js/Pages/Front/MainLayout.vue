            ...
            <div class="off-canvas-inner">
                <div id="of-mobile-nav" class="mobile-menu-wrap">
                    <ul class="mobile-menu">
                        ...
                        <li>
                            <Link href="/post/1">مقالات</Link>
                        </li>
                        <li><Link href="aboutus.html">درباره ما</Link></li>
                        <li><Link href="ContactUs.html">تماس با ما</Link></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="container p_relative h86">
                        <div id="navigation" class="of-drop-down of-main-menu" role="navigation">
                            <ul class="menu">
                                ...
                                <li><Link href="/post/1">مقالات</Link></li>
                                <li><Link href="aboutus.html">درباره ما</Link></li>
                                <li><Link href="ContactUs.html">تماس با ما</Link></li>
